...
String inline = "";
		...
		try {
			URL url = new URL("https://api.covid19india.org/state_test_data.json");
			...
			JSONArray jsonarr_1 = (JSONArray) jobj.get("states_tested_data");
...
<section class="corona_update container-fluid" id="indiacases">
	<div class="mb-3">
		...
		<h3 class="text-uppercase text-center">COVID-19 TESTING UPDATES OF INDIA</h3>
	</div>
...
<input id="myInput" type="text" placeholder="Entet State Name">
</p></center>
		<table class=" table table-bordered table-striped text-center" id="tbval">
			<tr style="color: #fff; background: #202020;">
				...
				<th>Last Update</th>
                        ...
                        <tr>
<%
				for(int i=0;i<jsonarr_1.size()-1;i++)
			{
				
				JSONObject jsonobj_1 = (JSONObject)jsonarr_1.get(i);
				JSONObject jsonobj_2 = (JSONObject)jsonarr_1.get(i+1);
				String st1=(String)jsonobj_1.get("state");
				String st2=(String)jsonobj_2.get("state");
				String st3=(String)jsonobj_2.get("totaltested");
				String st4=(String)jsonobj_1.get("totaltested");
				
				if(st1.equals(st2)&&!st3.equals("")) {
					continue;
				}
				System.out.println();
				if(st4.equals("")) {
					continue;
                                ...
                                %>
				<th><%=jsonobj_1.get("state")%></th>
				<th><%=jsonobj_1.get("updatedon")%></th>
				<th><%=jsonobj_1.get("totaltested")%></th>
