...
<nav class="navbar navbar-dark navbar-expand-lg nav_style p-3">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto pr-5 text-capitalize">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#indiacases">IndiaCoronaLive</a>
      </li>
      <li class="nav-item">
...
<input id="myInput" type="text" placeholder="Entet State Name">
            ...
            <div class="mb-3">
                ...
                <h3 class="text-uppercase text-center"><b>Click on State name to check district data</b></h3>
	</div>
		<table class=" table table-bordered table-striped text-center" id="tbval">
			<tr style="color: #fff; background: #202020;">
				...
				JSONObject jsonobj_1 = (JSONObject) jsonarr_1.get(i);
                                String st=(String)jsonobj_1.get("state");
                                
                                if(i==0){
                                st="INDIA";
                                }
                                %>
                                <th><a href="statewise.jsp?st=<%=st%>"><%=st%></a></th>
				<th><%=jsonobj_1.get("confirmed")%></th>
				<th><%=jsonobj_1.get("active")%></th>
				<th><%=jsonobj_1.get("recovered")%></th>
				<th><%=jsonobj_1.get("deaths")%></th>
